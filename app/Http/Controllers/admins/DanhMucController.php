...
class DanhMucController extends Controller
{
    ...
    public function index()
    {
     ...
     return view('admin.danhmucs.index', compact('title', 'listDanhMuc'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.danhmucs.create', compact('title'));
    }
    ...
    public function store(DanhMucRequest $request)
    {
        if($request->isMethod('POST')){
            ...
            if ($request->hasFile('hinh_anh')){
                $filepath = $request->file('hinh_anh')->store('uploads/danhmucs', 
                'public');
            } else {
                $filepath = null;
            }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.danhmucs.edit', compact('title','danhMuc'));
    }
