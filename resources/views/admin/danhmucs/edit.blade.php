                    ...
                    <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-sm-10 mb-3 d-flex gap-2">
                                        <div class="form-check">
                                            ...
                                            value="1" {{ $danhMuc->trang_thai == true ? 'checked' : ''}} checked>
                                            <label class="form-check-label text-success" for="gridRadios1">
                                               Hiển thị
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="trang_thai" id="gridRadios2" value="2" {{ $danhMuc->trang_thai == false ? 'checked' : ''}}>
                        ...
                        <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <img id="img_danh_muc" src="{{ Storage::url($danhMuc->hinh_anh)}}" width="150px"  alt="hình ảnh sản phầm">
                                </div>
